document.addEventListener('DOMContentLoaded', async function() {
  ...
  if (!intervalInput || !clearNowBtn || !statusDiv || !enableToggle || !toggleText || !settingsContainer) {
  ...
  async function toggleExtension() {
    ...
    try {
      ...
      if (response && response.success) {
        showStatus(enabled ? 'Extension Status: Enabled' : 'Extension Status: Disabled', 'success');
  ...
  function updateUI(enabled) {
    toggleText.textContent = enabled ? 'Extension Status: Enabled' : 'Extension Status: Disabled';
